...
const Project = () => {
  return (
    <div className='ProjectPage h-screen w-screen bg-primaryGradient-200 sm:px-60 px-8 flex justify-start pt-20 items-start flex-col'>
        <h2 className='inline-block text-white text-4xl font-semibold SLSS'>Project<span className='opacity-50'>'s</span></h2>
        <div className='sm:h-4/6 h-4/6 sm:w-5/6 bg-white/70 mt-10 relative'>
          ...
          <p className='absolute sm:left-12 sm:w-1/6 w-5/6 sm:bottom-auto bottom-10 text-gray-800 sm:mx-0 mx-6'>A place with thousands of unique design idea's for building application's faster</p>
